-- WOOX - Re-corrección de get_compiled_prompt (Sintaxis Ultrarobusta)
-- Esta versión separa el ordenamiento de la agregación para evitar errores de Postgres 42803.
...
BEGIN
    ...
    -- 3. Generar Catálogo con Ordenamiento Previo
