...
BEGIN
    ...
    -- Se elimina la inyección masiva del catálogo en el prompt base.
    -- La IA debe depender de la Habilidad RAG implementada en Python para buscar 
    -- específicamente lo que pregunta el cliente, reduciendo un 90% el consumo.
    -- (Solo dejamos una nota en texto para avisarle al LLM)
